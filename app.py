...
# Fungsi utama
def main():
    st.set_page_config(page_title="Rekomendasi Produk Pelatihan", page_icon="image/artificial-intelligence (1).png", layout="wide", initial_sidebar_state="collapsed", menu_items=None)
